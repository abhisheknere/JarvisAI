from groq import Groq # Importing the Groq library to use it's API.
...
# Define a system message that provides context to the AI chatbot about it's role and behaviour.
...
def RealtimeInformation():
    ...
    hour = current_date_time.strftime("%H") # Hour in 24-hours format.
