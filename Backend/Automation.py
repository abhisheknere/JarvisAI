...
SystemChatBot = [{"role": "system", "content": f"Hello, I am {os.environ['Username']}, You're a content writer. You have to write content like letters, codes, applications, esays, notes, songs, poems etc."}]
...
def YouTubeSearch(Topic):
    ...
    webbrowser.open(UrlSearch) # Open the search url in web browser.
    return True # Indicate success.
...
# if __name__ == "__main__":
    #asyncio.run(Automation(["open facebook", "open instagram", "open telegram", "play faasle", "content song faasle for me"]))       