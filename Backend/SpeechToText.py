...
# Replace the language setting in HTML code with input language from the environment variables.
...
def SpeechRecognition():
    ...
    while True:
        try:
            # Get the recognized text from HTML output elements.
           ########### Text = driver.find_element(by=By.ID, value="output").click()
            ...
            if Text:
                ...
                if InputLanguage.lower() == "en" or "en" in InputLanguage.lower():
                    ...
                    # If input language is not English, translate the text and return it.
